        ...
        If vblLength > 5 Then
            If rcText(0) = "%" And rcText(5) = "?" Then
                ...
                ElseIf rcText(1) = "X" Then
                    ...
                    Cursor.Position = New Point(Cursor.Position.X - (currentCur - 336) / 4, Cursor.Position.Y)
                ElseIf rcText(1) = "Y" Then
                    currentCur = Convert.ToDecimal(rcText.Substring(2, 3))
                    Cursor.Position = New Point(Cursor.Position.X, Cursor.Position.Y + (currentCur - 336) / 4)
